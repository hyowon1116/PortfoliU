...
public interface UserDao_todo {
    ...
    @Query("UPDATE Todo SET user_title = :t, user_lec = :l, user_year = :y, user_month= :m, user_date = :da, user_des = :d WHERE user_id =:id")
    void update(String t, String l, int y, int m, int da, String d, int id);
